# Sagacoin
## Windows wallet - bootstrap (25/Dec/19)
- Bootstrap block **735.533** for SagaCoin Windows wallet.
...
## Linux - Masternode bootstrap (25/Dec/19)
- Bootstrap block **735.533** for SagaCoin Linux hot masternode.
