# Sagacoin
## Windows wallet - bootstrap (05/Oct/19)
- Bootstrap block **641.925** for SagaCoin Windows wallet.
...
## Linux - Masternode bootstrap (05/Oct/19)
- Bootstrap block **641.925** for SagaCoin Linux hot masternode.
