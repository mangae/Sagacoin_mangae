# Sagacoin
## Windows wallet - bootstrap (05/Jun/19)
- Bootstrap block **528.426** for SagaCoin Windows wallet.
...
## Linux - Masternode bootstrap (05/Jun/19)
- Bootstrap block **528.426** for SagaCoin Linux hot masternode.
