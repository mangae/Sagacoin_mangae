# Sagacoin
## Windows wallet - bootstrap (20/May/19)
- Bootstrap block **509.153** for SagaCoin Windows wallet.
...
## Linux - Masternode bootstrap (20/May/19)
- Bootstrap block **509.153** for SagaCoin Linux hot masternode.
