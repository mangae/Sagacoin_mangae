# Sagacoin
## Windows wallet - bootstrap (14/Sep/19)
- Bootstrap block **618.945** for SagaCoin Windows wallet.
...
## Linux - Masternode bootstrap (14/Sep/19)
- Bootstrap block **618.945** for SagaCoin Linux hot masternode.
